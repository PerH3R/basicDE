...
class Agent {
public:
	Agent(size_t dimension, std::shared_ptr<Mutation> mutation_operator, std::shared_ptr<Crossover> crossover_operator, Boundary* boundary_correction, ioh::problem::RealSingleObjective* target_function, unsigned int* budget);
	~Agent();
	...
	std::tuple<std::vector<double>, double, std::shared_ptr<Crossover>, std::shared_ptr<Mutation>, Boundary*> update_history();
	void add_history(std::tuple<std::vector<double>, double, std::shared_ptr<Crossover>, std::shared_ptr<Mutation>, Boundary*> snapshot);
	std::vector< std::tuple<std::vector<double>, double, std::shared_ptr<Crossover>, std::shared_ptr<Mutation>, Boundary*> > get_history() {return this->history;};
...
private:
	...
	std::vector< std::tuple<std::vector<double>, double, std::shared_ptr<Crossover>, std::shared_ptr<Mutation>, Boundary*> > history;
